...
class Review(BaseModel):
    summary: str = Field(description="A concise summary of the review in one or two sentences.")
    sentiment: Literal["POSITIVE", "NEGATIVE", "NEUTRAL"] = Field(description="A sentiment of the review: positive, negative, or neutral.")
    pros: Optional[list[str]] = Field(default=None, description="A list of the positive aspects mentioned in the review if present.")
    cons: Optional[list[str]] = Field(default=None, description="A list of the negative aspects mentioned in the review if present..")
    key_themes: list[str] = Field(description="A list of the key themes of the products mentioned in the review.")  
